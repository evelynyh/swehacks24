...
(function () {
    ...
    globe.projection.scale(75).translate([75, 75]).rotate([0, -10, 0]);
    ...
    setInterval(function () {
        ...
        globe.plugins.objects.add(260.35, 37.0902, {
            imagesrc: "images/us.jpg",
            imageheight: 26,
            imagewidth: 40
        })
        globe.plugins.objects.add(132.10, 330.98, {
            imagesrc: "images/Flag-Australia.webp",
            imageheight: 26,
            imagewidth: 40
        })
